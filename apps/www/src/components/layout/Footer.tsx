      ...
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 font-sans">
          <div className="md:col-span-1">
            ...
            >
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-600 to-indigo-700 flex items-center justify-center shadow-md group-hover:shadow-lg transition-all duration-300">
            ...
            <p className="text-slate-600 text-sm leading-relaxed max-w-xs">
              ...
              Build modern, type-safe, and SEO-optimized SaaS applications.
            </p>
          </div>
